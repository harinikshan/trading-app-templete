import 'bloc/portfolio_vone_bloc.dart';
import 'models/portfolio_vone_model.dart';
...
class PortfolioVoneScreen extends StatelessWidget {
  PortfolioVoneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<PortfolioVoneBloc>(
      create: (context) => PortfolioVoneBloc(PortfolioVoneState(
        portfolioVoneModelObj: PortfolioVoneModel(),
      ))
        ..add(PortfolioVoneInitialEvent()),
      child: PortfolioVoneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<PortfolioVoneBloc, PortfolioVoneState>(
                            ...
                            children: [
                              TextSpan(
                                ...
                                style: CustomTextStyles
                                    .displaySmallOnErrorContainer,
                              ),
                              TextSpan(
                                text: "lbl_20".tr,
                                style: CustomTextStyles
                                    .headlineSmallOnErrorContainer_1,
                              ),
                            ],
                          ),
                          textAlign: TextAlign.left,
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        decoration:
                                            AppDecoration.outlineTeal.copyWith(
                                          borderRadius:
  ...
  Widget _buildTrash(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Spacer(),
        CustomImageView(
          imagePath: ImageConstant.imgChartDeepOrangeA200,
          height: 32.v,
          width: 80.h,
          margin: EdgeInsets.only(
            top: 8.v,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: CustomTextStyles.labelLargeRed900,
                      ),
                    ),
                  ],
                ),
